...
public class EventCenter : MonoBehaviour
{
    ...
    public void TriggerLayerSwitched(LayerSwitchedEventArgs args)
    {
        OnLayerSwitched?.Invoke(this, args);
    }

    public void TriggerPlayerArrived(PlayerArrivedEventArgs args)
    {
        OnPlayerArrived?.Invoke(this, args);
    }
    ...
    public void TriggerGridEvent(GridEventTriggerEventArgs args)
    {
        OnGridEventTrigger?.Invoke(this, args);
    }

    // 触发战斗检查请求
    public void TriggerBattleCheckRequest(BattleCheckEventArgs args)
    {
        OnBattleCheckRequest?.Invoke(this, args);
    }

    // 新：触发实体动画完成事件
    public void TriggerEntityAnimationFinished(EntityAnimationEventArgs args)
    {
        OnEntityAnimationFinished?.Invoke(this, args);
    }
}