...
namespace Modules.Player.Runtime.Attribute
{
    /// <summary>
    ...
    {
        [FormerlySerializedAs("InitAttributes")] [Tooltip("初始属性列表")] [SerializeField]
        private List<AttributeBonus> initAttributes = new();
        ...
        public void ResetAttribute()
        {
            ...
            foreach (var attr in initAttributes.Where(attr => attr != null && attr.type != AttributeType.All))
            {
